...
var _user$project$Escape$dict = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: '&#8482;', _1: '™'},
			{ctor: '_Tuple2', _0: '&#32;', _1: ' '},
...
var _user$project$HtmlParser_ops = _user$project$HtmlParser_ops || {};
_user$project$HtmlParser_ops['*>'] = F2(
	function (lp, rp) {
		return A2(
			_Bogdanp$elm_combine$Combine$andMap,
			A2(
...
var _user$project$HtmlParser$comment = A2(
	_Bogdanp$elm_combine$Combine$map,
...
var _user$project$HtmlParser$isInvalidNest = F2(
	function (tagName, childTagName) {
		return (_elm_lang$core$Native_Utils.eq(tagName, 'li') && _elm_lang$core$Native_Utils.eq(childTagName, 'li')) || ((_elm_lang$core$Native_Utils.eq(tagName, 'dt') && (_elm_lang$core$Native_Utils.eq(childTagName, 'dt') || _elm_lang$core$Native_Utils.eq(childTagName, 'dd'))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'dd') && (_elm_lang$core$Native_Utils.eq(childTagName, 'dt') || _elm_lang$core$Native_Utils.eq(childTagName, 'dd'))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'p') && A2(_elm_lang$core$Set$member, childTagName, _user$project$HtmlParser$ngSetForP)) || ((_elm_lang$core$Native_Utils.eq(tagName, 'rt') && (_elm_lang$core$Native_Utils.eq(childTagName, 'rt') || _elm_lang$core$Native_Utils.eq(childTagName, 'rp'))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'rp') && (_elm_lang$core$Native_Utils.eq(childTagName, 'rt') || _elm_lang$core$Native_Utils.eq(childTagName, 'rp'))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'optgroup') && _elm_lang$core$Native_Utils.eq(childTagName, 'optgroup')) || ((_elm_lang$core$Native_Utils.eq(tagName, 'option') && (_elm_lang$core$Native_Utils.eq(childTagName, 'option') || _elm_lang$core$Native_Utils.eq(childTagName, 'optgroup'))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'colgroup') && (!_elm_lang$core$Native_Utils.eq(childTagName, 'col'))) || (_elm_lang$core$Native_Utils.eq(tagName, 'caption') || ((_elm_lang$core$Native_Utils.eq(tagName, 'thead') && (_elm_lang$core$Native_Utils.eq(childTagName, 'tbody') || _elm_lang$core$Native_Utils.eq(childTagName, 'tfoot'))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'tbody') && (_elm_lang$core$Native_Utils.eq(childTagName, 'tbody') || (_elm_lang$core$Native_Utils.eq(childTagName, 'tfoot') || _elm_lang$core$Native_Utils.eq(childTagName, 'table')))) || ((_elm_lang$core$Native_Utils.eq(tagName, 'tfoot') && _elm_lang$core$Native_Utils.eq(childTagName, 'table')) || ((_elm_lang$core$Native_Utils.eq(tagName, 'tr') && _elm_lang$core$Native_Utils.eq(childTagName, 'tr')) || ((_elm_lang$core$Native_Utils.eq(tagName, 'td') && (_elm_lang$core$Native_Utils.eq(childTagName, 'td') || (_elm_lang$core$Native_Utils.eq(childTagName, 'th') || (_elm_lang$core$Native_Utils.eq(childTagName, 'tr') || (_elm_lang$core$Native_Utils.eq(childTagName, 'tbody') || _elm_lang$core$Native_Utils.eq(childTagName, 'tfoot')))))) || (_elm_lang$core$Native_Utils.eq(tagName, 'th') && (_elm_lang$core$Native_Utils.eq(childTagName, 'td') || (_elm_lang$core$Native_Utils.eq(childTagName, 'th') || (_elm_lang$core$Native_Utils.eq(childTagName, 'tr') || (_elm_lang$core$Native_Utils.eq(childTagName, 'tbody') || _elm_lang$core$Native_Utils.eq(childTagName, 'tfoot'))))))))))))))))))));
	});
var _user$project$HtmlParser$optionalEndTag = _elm_lang$core$Set$fromList(
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$HtmlParser$spaced = function (p) {
	return A3(_Bogdanp$elm_combine$Combine$between, _user$project$HtmlParser$spaces, _user$project$HtmlParser$spaces, p);
};
var _user$project$HtmlParser$Comment = function (a) {
	return {ctor: 'Comment', _0: a};
};
var _user$project$HtmlParser$commentNode = A2(_Bogdanp$elm_combine$Combine$map, _user$project$HtmlParser$Comment, _user$project$HtmlParser$comment);
...
var _user$project$HtmlParser$Text = function (a) {
	return {ctor: 'Text', _0: a};
};
var _user$project$HtmlParser$textNode = A2(
	_Bogdanp$elm_combine$Combine$map,
	_user$project$HtmlParser$Text,
	_Bogdanp$elm_combine$Combine$regex('[^<]*'));
var _user$project$HtmlParser$commentOrTextNode = A2(_Bogdanp$elm_combine$Combine$or, _user$project$HtmlParser$commentNode, _user$project$HtmlParser$textNode);
var _user$project$HtmlParser$NoValue = {ctor: 'NoValue'};
var _user$project$HtmlParser$NumberValue = function (a) {
	return {ctor: 'NumberValue', _0: a};
};
var _user$project$HtmlParser$attributeValueNumber = A2(
	_Bogdanp$elm_combine$Combine$map,
	_user$project$HtmlParser$NumberValue,
	_Bogdanp$elm_combine$Combine$regex('[0-9][0-9.]*'));
var _user$project$HtmlParser$StringValue = function (a) {
	return {ctor: 'StringValue', _0: a};
};
var _user$project$HtmlParser$attributeValueString = A2(
	_Bogdanp$elm_combine$Combine$or,
	A2(
		_Bogdanp$elm_combine$Combine$map,
...
var _user$project$HtmlParser$attributeValueBareString = A2(
	_Bogdanp$elm_combine$Combine$map,
	_user$project$HtmlParser$StringValue,
	_Bogdanp$elm_combine$Combine$regex('[a-zA-Z0-9\\-]+'));
var _user$project$HtmlParser$attributeValue = A2(
	_Bogdanp$elm_combine$Combine$or,
	A2(_Bogdanp$elm_combine$Combine$or, _user$project$HtmlParser$attributeValueNumber, _user$project$HtmlParser$attributeValueString),
	_user$project$HtmlParser$attributeValueBareString);
var _user$project$HtmlParser$attributeNameValuePair = A2(
	_Bogdanp$elm_combine$Combine$andMap,
	A2(
		_Bogdanp$elm_combine$Combine$andMap,
		A2(
			...
			_Bogdanp$elm_combine$Combine$string('=')),
		_user$project$HtmlParser$spaces),
	_user$project$HtmlParser$attributeValue);
var _user$project$HtmlParser$attribute = A2(
	_Bogdanp$elm_combine$Combine$or,
	...
	A2(
		...
		A2(
			...
			_user$project$HtmlParser$NoValue),
		_user$project$HtmlParser$attributeName));
					...
					A2(
						...
						A2(
							...
							A2(
								_Bogdanp$elm_combine$Combine$map,
								F6(
									function (_p16, tagName, _p15, attrs, _p14, _p13) {
										return {
											ctor: '_Tuple2',
											_0: _elm_lang$core$String$toLower(tagName),
											_1: attrs
...
var _user$project$HtmlParser$singleNode = A2(
	...
	_user$project$HtmlParser$singleTag);
		...
		function (_p19) {
			return A2(
				...
				A2(
					...
					A2(
						_Bogdanp$elm_combine$Combine$or,
						A2(_Bogdanp$elm_combine$Combine$or, _user$project$HtmlParser$doctypeNode, _user$project$HtmlParser$singleNode),
						_user$project$HtmlParser$normalNode(parentTagName)),
					_user$project$HtmlParser$commentNode),
				...
				function (_p21) {
					...
					return (_elm_lang$core$Native_Utils.eq(_p26, 'script') || _elm_lang$core$Native_Utils.eq(_p26, 'style')) ? A2(
						...
						A2(
							_Bogdanp$elm_combine$Combine$map,
							F2(
								function (children, _p23) {
									return A3(_user$project$HtmlParser$Node, _p26, _p25, children);
								}),
							_Bogdanp$elm_combine$Combine$many(_user$project$HtmlParser$commentOrTextNode)),
						_user$project$HtmlParser$endTag(_p26)) : (A2(_user$project$HtmlParser$isInvalidNest, parentTagName, _p26) ? _Bogdanp$elm_combine$Combine$fail(
						_elm_lang$core$Native_List.fromArray(
							[])) : (A2(_elm_lang$core$Set$member, _p26, _user$project$HtmlParser$startTagOnly) ? _Bogdanp$elm_combine$Combine$succeed(
						A3(
							_user$project$HtmlParser$Node,
							_p26,
							_p25,
						...
						A2(
							_Bogdanp$elm_combine$Combine$map,
							F2(
								function (children, _p24) {
									return A3(_user$project$HtmlParser$Node, _p26, _p25, children);
								}),
							_Bogdanp$elm_combine$Combine$many(
								_user$project$HtmlParser$node(_p26))),
						(A2(_elm_lang$core$Set$member, _p26, _user$project$HtmlParser$optionalEndTag) ? _Bogdanp$elm_combine$Combine$optional(
							{ctor: '_Tuple0'}) : _elm_lang$core$Basics$identity)(
							_user$project$HtmlParser$endTag(_p26)))));
				});
		});
};
...
var _user$project$Demo$toAttribute = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1._0;
	var _p2 = _p1._1;
	switch (_p2.ctor) {
		case 'StringValue':
			return A2(_elm_lang$html$Html_Attributes$attribute, _p3, _p2._0);
		case 'NumberValue':
			return A2(_elm_lang$html$Html_Attributes$attribute, _p3, _p2._0);
		default:
			return A2(_elm_lang$html$Html_Attributes$attribute, _p3, '');
	}
};
	...
	switch (_p4.ctor) {
		case 'Node':
			return A3(
				...
				_p4._0,
				A2(_elm_lang$core$List$map, _user$project$Demo$toAttribute, _p4._1),
				A2(_elm_lang$core$List$map, _user$project$Demo$toVirtualDom, _p4._2));
		case 'Text':
...
var _user$project$Demo$show = function (model) {
	return _elm_lang$core$Native_Utils.update(
		...
		{
			dest: function () {
				var _p5 = _user$project$HtmlParser$parse(model.src);
				if (_p5.ctor === 'Ok') {
					return A2(_elm_lang$core$List$map, _user$project$Demo$toVirtualDom, _p5._0);
				} else {
					return _elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
...
var _user$project$Demo$initialModel = {
	src: '',
	dest: _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('')
		])
};
...
var _user$project$Demo$Init = function (a) {
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_user$project$Demo$initialModel,
				_elm_lang$core$Native_List.fromArray(
					[])),
			update: F2(
				function (msg, model) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_user$project$Demo$update, msg, model),
						_elm_lang$core$Native_List.fromArray(
							[]));
				}),
